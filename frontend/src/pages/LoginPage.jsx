  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, var(--secondary), #2d1b4e)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ background: 'white', borderRadius: 16, padding: 40, width: '100%', maxWidth: 420, boxShadow: 'var(--shadow-lg)' }}>
        ...
        {/* Error message */}
        {error && (
          <div style={{ background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 8, padding: '10px 14px', marginBottom: 16, color: 'var(--danger)', fontSize: '0.875rem', display: 'flex', gap: 8, alignItems: 'flex-start' }}>
            <i className="bi bi-exclamation-circle-fill" style={{ flexShrink: 0, marginTop: 2 }} />
            {error}
          </div>
        )}
        ...
        <div style={{ marginTop: 24, textAlign: 'center', fontSize: '0.83rem', color: 'var(--gray-500)' }}>
          ...
          <p style={{ marginTop: 4 }}>
            For admin panel: <a href="/admin" style={{ color: 'var(--primary)', fontWeight: 600 }}>Django Admin →</a>
          </p>
        </div>
